...
export function getCurrentSprint(referenceDate = todayDateString()) {
    const active = SPRINTS.find((s) => referenceDate >= s.startDate && referenceDate <= s.endDate);
...
export function getPreviousSprint(current) {
