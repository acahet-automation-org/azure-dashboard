import { getActiveWorkItemIds, getRecentlyChangedWorkItemIds, getFollowedWorkItemIds, getCreatedWorkItemIds, getCommentMentions, getWorkItems, buildWorkItemUrl, } from "./azdo.js";
...
export async function getMentionedWorkItems() {
    const ids = await getRecentlyChangedWorkItemIds(MENTION_SCAN_WINDOW_DAYS);
    ...
    const items = await getWorkItems([...mentionsById.keys()], MY_WORK_ITEM_FIELDS);
    return items.map((wi) => ({
